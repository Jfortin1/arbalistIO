...
RcppExport SEXP _arbalistIO_fragments_to_regions(SEXP fragment_fileSEXP, SEXP output_fileSEXP, SEXP output_groupSEXP, SEXP seqnamesSEXP, SEXP region_idsSEXP, SEXP region_startsSEXP, SEXP region_endsSEXP, SEXP cellnamesSEXP, SEXP num_regionsSEXP, SEXP deflate_levelSEXP, SEXP chunk_dimSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _arbalistIO_fragments_to_tiles(SEXP fragment_fileSEXP, SEXP tile_sizeSEXP, SEXP output_fileSEXP, SEXP output_groupSEXP, SEXP seqlengthsSEXP, SEXP seqnamesSEXP, SEXP cellnamesSEXP, SEXP deflate_levelSEXP, SEXP chunk_dimSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< std::string >::type fragment_file(fragment_fileSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_arbalistIO_fragments_to_regions", (DL_FUNC) &_arbalistIO_fragments_to_regions, 11},
    {"_arbalistIO_fragments_to_tiles", (DL_FUNC) &_arbalistIO_fragments_to_tiles, 9},
    {NULL, NULL, 0}
};

RcppExport void R_init_arbalistIO(DllInfo *dll) {
